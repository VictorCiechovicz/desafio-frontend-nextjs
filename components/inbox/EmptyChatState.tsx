...
export function EmptyChatState() {
  return (
    <section
      ...
      className="hidden h-full flex-1 flex-col items-center justify-center bg-background px-8 text-center md:flex"
    >
      <div
        aria-hidden
      ...
      <h2 className="text-base font-medium text-foreground">Selecione uma conversa</h2>
